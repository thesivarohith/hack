...
if not _is_authenticated:
    ...
    if "fb_token" in params and "fb_uid" in params:
        ...
        # FirebaseUI Sign-In Component Area
        ...
        if not st.session_state.show_login_ui:
            ...
            if FIREBASE_AUTH_ENABLED:
                ...
                <div id="firebaseui-auth-container" style="display:flex; justify-content:center; padding: 0;"></div>
                ...
                """
                components.html(firebase_login_html, height=280)
            else:
                col_l, col_mid, col_r = st.columns([2, 2, 2])
                with col_mid:
                    st.warning("⚠️ Firebase keys not set — social login unavailable in local mode.")
                    st.markdown("<br>", unsafe_allow_html=True)
